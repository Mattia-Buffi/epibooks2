  ...
  return (
    <Form className={"border-success border rounded p-2 my-4"+(theme=='light'?'':' text-secondary')} >
        ...
        <Form.Group className="mb-3" controlId="reting">
            <Form.Label>Inserisci rate: <strong>{rate}</strong> <span>{rateTemp}</span></Form.Label>
            <Form.Range min={1} max={5} step={1} placeholder='1' onChange={(e)=>setRate(e.target.value)}/>
        </Form.Group>
